...
def main(args=None):
    ...
    parser.add_option('--output', action='store', help='File name to write output to. If unspecified, image will be shown.')
    ...
    if options.subtitle:
        ...
        d.text((subtitle_pos[0]+shadow_offset, subtitle_pos[1]+shadow_offset), options.subtitle, font=subtitle_font, fill=shadow_colour)
