...
var GraphBase = Class.create({
    ...
    */
    ...
    drawSinglePoint: function (x, y) {
        // just draw a circle on the canvas
        this.graphContext.beginPath();
        this.graphContext.fillStyle = "#000";
        var scaledX = Math.round(this.scaleX(x));
        var scaledY = Math.round(this.yToCanvas(this.scaleY(y)));
        this.graphContext.arc(scaledX, scaledY, 2, 0, Math.PI * 2, true);
        this.graphContext.fill();
    },
